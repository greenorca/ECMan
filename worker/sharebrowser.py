...
class ShareBrowser(object):
    ...
    def __init__(self, servername, username, password, domain="", is_direct_tcp=False, port = 139):
        '''
        Constructor
    ...
    def connect(self):
        ...
        #--------------------------------------------------------------- except:
            #------------ self.isConnected = self.conn.connect(self.server, 445) for if is_direct_tcp=True
#------------------------------------------------------------------------------ 
