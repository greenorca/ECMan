...
class ShareBrowser(object):
    ...
    def connect(self):
        '''
        establishes connection (for the user setup in ctor) 
        '''
        ...
        try:
            ...
            pass
        self.conn = SMBConnection(self.user, self.password,
                                  socket.gethostname(),
                                  self.serverName,
                                  domain=self.domain,
...
if __name__ == "__main__":
    ...
    try:
        ...
        directories = os.linesep.join(
            x.filename for x in fileList if x.isDirectory and x.filename != ".." and x.filename != ".")
